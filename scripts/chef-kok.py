#!/usr/bin/env python3
"""
Runner voor Chef Kok agent

Zie: governance/rolbeschrijvingen/chef-kok.md
Prompt: .github/prompts/chef-kok.prompt.md

Gebruik:
    python scripts/chef-kok.py [argumenten]
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Chef Kok agent runner",
