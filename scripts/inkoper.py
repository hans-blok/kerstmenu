#!/usr/bin/env python3
"""
Runner voor Inkoper agent

Zie: governance/rolbeschrijvingen/inkoper.md
Prompt: .github/prompts/inkoper.prompt.md

Gebruik:
    python scripts/inkoper.py [argumenten]
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Inkoper agent runner",
