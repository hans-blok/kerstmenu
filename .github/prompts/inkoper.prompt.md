...
**VERPLICHT**: Lees `governance/rolbeschrijvingen/inkoper.md` voor volledige context en verantwoordelijkheden.
...
**Voorbeelden**:
```
@github /inkoper [voorbeeld opdracht 1]
@github /inkoper [voorbeeld opdracht 2]
@github /inkoper [voorbeeld opdracht 3] --check-only
```
...
**Documentatie**: Zie [governance/rolbeschrijvingen/inkoper.md](governance/rolbeschrijvingen/inkoper.md)  
**Runner**: `scripts/inkoper.py`
